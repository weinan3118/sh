...
function(a) {
    ...
    c = function(d, e) {
        ...
        function g() {
            t.autoplayTimeoutId = setTimeout(function() {
                t.params.loop ? (t.fixLoop(), t._slideNext(), t.emit("onAutoplay", t)) : t.isEnd ? e.autoplayStopOnLast ? t.stopAutoplay() : (t._slideTo(0), t.emit("onAutoplay", t)) : (t._slideNext(), t.emit("onAutoplay", t))
            },
            t.params.autoplay)
        }
        function h(b, c) {
        ...
        var n = e && e.virtualTranslate;
        e = e || {};
        var o = {};
        for (var p in e) if ("object" != typeof e[p] || null === e[p] || (e[p].nodeType || e[p] === window || e[p] === document || "undefined" != typeof Dom7 && e[p] instanceof Dom7 || "undefined" != typeof jQuery && e[p] instanceof jQuery)) o[p] = e[p];
        else {
            o[p] = {};
            for (var q in e[p]) o[p][q] = e[p][q]
        }
        for (var r in b) if ("undefined" == typeof e[r]) e[r] = b[r];
        else if ("object" == typeof e[r]) for (var s in b[r])"undefined" == typeof e[r][s] && (e[r][s] = b[r][s]);
        var t = this;
        if (t.params = e, t.originalParams = o, t.classNames = [], t.$ = a, t.currentBreakpoint = void 0, t.getActiveBreakpoint = function() {
            if (!t.params.breakpoints) return ! 1;
            var a, b = !1,
            c = [];
            for (a in t.params.breakpoints) t.params.breakpoints.hasOwnProperty(a) && c.push(a);
            c.sort(function(a, b) {
                return pa rseInt(a, 10) > parseInt(b, 10)
            });
        ...
        t.params.breakpoints && t.setBreakpoint(), t.container = a(d), 0 !== t.container.length) {
            ...
            t.startAutoplay = function() {
                return "undefined" != typeof t.autoplayTimeoutId ? !1 : t.params.autoplay ? t.autoplaying ? !1 : (t.autoplaying = !0, t.emit("onAutoplayStart", t), void g()) : !1
            },
            t.stopAutoplay = function(a) {
                t.autoplayTimeoutId && (t.autoplayTimeoutId && clearTimeout(t.autoplayTimeoutId), t.autoplaying = !1, t.autoplayTimeoutId = void 0, t.emit("onAutoplayStop", t))
            },
            t.pauseAutoplay = function(a) {
                t.autoplayPaused || (t.autoplayTimeoutId && clearTimeout(t.autoplayTimeoutId), t.autoplayPaused = !0, 0 === a ? (t.autoplayPaused = !1, g()) : t.wrapper.transitionEnd(function() {
                    t && (t.autoplayPaused = !1, t.autoplaying ? g() : t.stopAutoplay())
                }))
            },
            ...
            t.updateClasses = function() {
                ...
                var b = t.slides.eq(t.activeIndex);
                b.addClass(t.params.slideActiveClass);
                var c = b.next("." + t.params.slideClass).addClass(t.params.slideNextClass);
                t.params.loop && 0 === c.length && t.slides.eq(0).addClass(t.params.slideNextClass);
                var d = b.prev("." + t.params.slideClass).addClass(t.params.slidePrevClass);
                if (t.params.loop && 0 === d.length && t.slides.eq( - 1).addClass(t.params.slidePrevClass), t.paginationContainer && t.paginationContainer.length > 0) {
                    ...
                    if (t.params.loop ? (e = Math.ceil((t.activeIndex - t.loopedSlides) / t.params.slidesPerGroup), e > t.slides.length - 1 - 2 * t.loopedSlides && (e -= t.slides.length - 2 * t.loopedSlides), e > f - 1 && (e -= f), 0 > e && "bullets" !== t.params.paginationType && (e = f + e)) : e = "undefined" != typeof t.snapIndex ? t.snapIndex: t.activeIndex || 0, "bullets" === t.params.paginationType && t.bullets && t.bullets.length > 0 && (t.bullets.removeClass(t.params.bulletActiveClass), t.paginatio nContainer.length > 1 ? t.bullets.each(function() {
                        a(this).index() === e && a(this).addClass(t.params.bulletActiveClass)
            ...
            t.initEvents = function(a) {
                ...
                (t.params.preventClicks || t.params.preventClicksPropagation) && d[c]("click", t.preventClicks, !0)
            },
            ...
            t.onClickIndex = function(b) {
                b.preventDefault();
                var c = a(this).index() * t.params.slidesPerGroup;
                t.params.loop && (c += t.loopedSlides),
                t.slideTo(c)
            },
            t.updateClickedSlide = function(b) {
                var c = h(b, "." + t.params.slideClass),
                d = !1;
                if (c) for (var e = 0; e < t.slides.length; e++) t.slides[e] === c && (d = !0);
                if (!c || !d) return t.clickedSlide = void 0,
                void(t.clickedIndex = void 0);
                if (t.clickedSlide = c, t.clickedIndex = a(c).index(), t.params.slideToClickedSlide && void 0 !== t.clickedIndex && t.clickedIndex !== t.activeIndex) {
                    var f, g = t.clickedIndex;
                    if (t.params.loop) {
                        if (t.animating) return;
                        f = a(t.clickedSlide).attr("data-swiper-slide-index"),
                        t.params.centeredSlides ? g < t.loopedSlides - t.params.slidesPerView / 2 || g > t.slides.length - t.loopedSlides + t.params.slidesPerView / 2 ? (t.fixLoop(), g = t.wrapper.children("." + t.params.slideClass + '[data-swiper-slide-index="' + f + '"]:not(.swiper-slide-duplicate)').eq(0).index(), setTimeout(function() {
                            t.slideTo(g)
                        },
                        0)) : t.slideTo(g) : g > t.slides.length - t.params.slidesPerView ? (t.fixLoop(), g = t.wrapper.children("." + t.params.slideClass + '[data-swiper-slide-index="' + f + '"]:not(.swiper-slide-duplicate)').eq(0).index(), setTimeout(function() {
                            t.slideTo(g)
                        },
                        0)) : t.slideTo(g)
                    } else t.slideTo(g)
            ...
            var J, K;
            if (t.onTouchStart = function(b) {
                if (b.originalEvent && (b = b.originalEvent), J = "touchstart" === b.type, J || !("which" in b) || 3 !== b.which) {
                    if (t.params.noSwiping && h(b, "." + t.p arams.noSwipingClass)) return void(t.allowClick = !0);
                    if (!t.params.swipeHandler || h(b, t.params.swipeHandler)) {
                        var c = t.touches.currentX = "touchstart" === b.type ? b.targetTouches[0].pageX: b.pageX,
                        d = t.touches.currentY = "touchstart" === b.type ? b.targetTouches[0].pageY: b.pageY;
                        if (! (t.device.ios && t.params.iOSEdgeSwipeDetection && c <= t.params.iOSEdgeSwipeThreshold)) {
                            if (w = !0, x = !1, y = !0, A = void 0, K = void 0, t.touches.startX = c, t.touches.startY = d, z = Date.now(), t.allowClick = !0, t.updateContainerSize(), t.swipeDirection = void 0, t.params.threshold > 0 && (D = !1), "touchstart" !== b.type) {
                                var e = !0;
                                a(b.target).is(G) && (e = !1),
                                document.activeElement && a(document.activeElement).is(G) && document.activeElement.blur(),
                                e && b.preventDefault()
                            }
                            t.emit("onTouchStart", t, b)
                        }
                    }
                }
            },
            t.onTouchMove = function(b) {
                if (b.originalEvent && (b = b.originalEvent), !J || "mousemove" !== b.type) {
                    if (b.preventedByNestedSwiper) return t.touches.startX = "touchmove" === b.type ? b.targetTouches[0].pageX: b.pageX,
                    void(t.touches.startY = "touchmove" === b.type ? b.targetTouches[0].pageY: b.pageY);
                    if (t.params.onlyExternal) return t.allowClick = !1,
                    void(w && (t.touches.startX = t.touches.currentX = "touchmove" === b.type ? b.targetTouches[0].pageX: b.pageX, t.touches.startY = t.touches.currentY = "touchmove" === b.type ? b.targetTouches[0].pageY: b.pageY, z = Date.now()));
                    if (J && document.activeElement && b.target === document.activeElement && a(b.target).is(G)) return x = !0,
                    void(t.allowClick = !1);
                    if (y && t.emit("onTouchMove", t, b), !(b.targetTouches && b.targetTouches.length > 1)) {
                        if (t.touches.currentX = "touchmove" === b.type ? b.targetTouches[0].pageX: b.pageX, t.touches.currentY = "touchmove" === b.type ? b.targetTouches[0].pageY: b.pageY, "undefined" == typeof A) {
                        ...
                        if (A && t.emit("onTouchMoveOpposite", t, b), "undefined" == typeof K && t.browser.ieTouch && (t.touches.currentX !== t.touches.startX || t.touches.currentY !== t.touches.startY) && (K = !0), w) {
                            if (A) return void(w = !1);
                            if (K || !t.browser.ieTouch) {
                                t.allowClick = !1,
                                t.emit("onSliderMove", t, b),
                                b.preventDefault(),
                                t.params.touchMoveStopPropagation && !t.params.nested && b.stopPropagation(),
                                x || (e.loop && t.fixLoop(), C = t.getWrapperTranslate(), t.setWrapperTransition(0), t.animating && t.wrapper.trigger("webkitTransitionEnd transitionend oTransitionEnd MSTransitionEnd msTransitionEnd"), t.params.autoplay && t.autoplaying && (t.params.autoplayDisableOnInteraction ? t.stopAutoplay() : t.pauseAutoplay()), F = !1, t.params.grabCursor && (t.container[0].style.cursor = "move", t.container[0].style.cursor = "-webkit-grabbing", t.container[0].style.cursor = "-moz-grabbin", t.container[0].style.cursor = "grabbing")),
                                x = !0;
                                var d = t.touches.diff = t.isHorizontal() ? t.touches.currentX - t.touches.startX: t.touches.currentY - t.touches.startY;
                                d *= t.params.touchRatio,
                                t.rtl && (d = -d),
                                t.swipeDirection = d > 0 ? "prev": "next",
                                B = d + C;
                                var f = !0;
                                if (d > 0 && B > t.minTranslate() ? (f = !1, t.params.resistance && (B = t.minTranslate() - 1 + Math.pow( - t.minTranslate() + C + d, t.params.resistanceRatio))) : 0 > d && B < t.maxTranslate() && (f = !1, t.params.resistance && (B = t.maxTranslate() + 1 - Math.pow(t.maxTranslate() - C - d, t.params.resistanceRatio))), f && (b.preventedByNestedSwiper = !0), !t.params.allowSwipeToNext && "next" === t.swipeDirection && C > B && (B = C), !t.params.allowSwipeToPrev && "prev" === t.swipeDirection && B > C && (B = C), t.params.followFinger) {
                                    if (t.params.threshold > 0) {
                                        if (! (Math.abs(d) > t.params.threshold || D)) return void(B = C);
                                        if (!D) return D = !0,
            ...
            t.onTouchEnd = function(b) {
                if (b.originalEvent && (b = b.originalEvent), y && t.emit("onTouchEnd", t, b), y = !1, w) {
                    ...
                    var c = Date.now(),
                    d = c - z;
                    if (t.allowClick && (t.updateClickedSlide(b), t.emit("onTap", t, b), 300 > d && c - H > 300 && (E && clearTimeout(E), E = setTimeout(function() {
                        t && (t.params.paginationHide && t.paginationContainer.length > 0 && !a(b.target).hasClass(t.params.bulletClass) && t.paginationContainer.toggleClass(t.params.paginationHiddenClass), t.emit("onClick", t, b))
                    },
                    300)), 300 > d && 300 > c - H && (E && clearTimeout(E), t.emit("onDoubleTap", t, b))), H = Date.now(), setTimeout(function() {
                        t && (t.allowClick = !0)
                    },
                    ...
                    if (d > t.params.longSwipesMs) {
                        ...
                        "next" === t.swipeDirection && (v >= t.par ams.longSwipesRatio ? t.slideTo(s + t.params.slidesPerGroup) : t.slideTo(s)),
            ...
            t.setWrapperTranslate = function(a, b, c) {
                ...
                e = 0,
                g = 0;
                t.isHorizontal() ? d = t.rtl ? -a: a: e = a,
                t.params.roundLengths && (d = f(d), e = f(e)),
                t.params.virtualTranslate || (t.support.transforms3d ? t.wrapper.transform("translate3d(" + d + "px, " + e + "px, " + g + "px)") : t.wrapper.transform("translate(" + d + "px, " + e + "px)")),
                t.translate = t.isHorizontal() ? d: e;
            ...
            t.observers = [], t.initObservers = function() {
                if (t.params.observeParents) for (var a = t.container.parents(), b = 0; b < a.length; b++) i(a[b]);
                i(t.container[0], {
                    childList: !1
                }),
                i(t.wrapper[0], {
            ...
            t.createLoop = function() {
                ...
                var b = t.wrapper.children("." + t.params.slideClass);
                "auto" !== t.params.slidesPerView || t.params.loopedSlides || (t.params.loopedSlides = b.length),
                t.loopedSlides = parseInt(t.params.loopedSlides || t.params.slidesPerView, 10),
                t.loopedSlides = t.loopedSlides + t.params.loopAdditionalSlides,
                t.loopedSlides > b.length && (t.loopedSlides = b.length);
                var c, d = [],
                e = [];
                for (b.each(function(c, f) {
                    var g = a(this);
                    c < t.loopedSlides && e.push(f),
                    c < b.length && c >= b.length - t.loopedSlides && d.push(f),
                    g.attr("data-swiper-slide-index", c)
                }), c = 0; c < e.length; c++) t.wrapper.append(a(e[c].cloneNode(!0)).addClass(t.params.slideDuplicateClass));
                for (c = d.length - 1; c >= 0; c--) t.wrapper.prepend(a(d[c].cloneNode(!0)).addClass(t.params.slideDuplicateClass))
            },
            ...
            t.effects = {
                ...
                flip: {
                    setTranslate: function() {
                        for (var b = 0; b < t.slides.length; b++) {
                            var c = t.slides.eq(b),
                            d = c[0].progress;
                            ...
                            if (t.isHorizontal() ? t.rtl && (g = -g) : (j = i, i = 0, h = -g, g = 0), c[0].style.zIndex = -Math.abs(Math.round(d)) + t.slides.length, t.params.flip.slideShadows) {
                                ...
                                0 === k.length && (k = a('<div class="swiper-slide-shadow-' + (t.isHorizontal() ? "left": "top") + '"></div>'), c.append(k)),
                                0 === l.length && (l = a('<div class="swiper-slide-shadow-' + (t.isHorizontal() ? "right": "bottom") + '"></div>'), c.append(l)),
                    ...
                    setTransition: function(b) {
                        if (t.slides.transition(b).find(".swiper-slide-shadow-top, .swiper-slide-shadow-right, .swiper-slide-shadow-bottom, .swiper-slide-shadow-left").transition(b), t.params.virtualTranslate && 0 !== b) {
                            var c = !1;
                            t.slides.eq(t.activeIndex).transitionEnd(function() {
                                if (!c && t && a(this).hasClass(t.params.slideActiveClass)) {
                                    c = !0,
                                    t.animating = !1;
                                    for (var b = ["webkitTransitionEnd", "transitionend", "oTransitionEnd", "MSTransitionEnd", "msTransitionEnd"], d = 0; d < b.length; d++) t.wrapper.trigger(b[d])
                                }
                            })
                        }
                    }
                ...
                cube: {
                    setTranslate: function() {
                        var b, c = 0;
                        t.params.cube.shadow && (t.isHorizontal() ? (b = t.wrapper.find(".swiper-cube-shadow"), 0 === b.length && (b = a('<div class="swiper-cube-shadow"></div>'), t.wrapper.append(b)), b.css({
                            height: t.width + "px"
                        })) : (b = t.container.find(".swiper-cube-shadow"), 0 === b.length && (b = a('<div class="swiper-cube-shadow"></div>'), t.container.append(b))));
                        for (var d = 0; d < t.slides.length; d++) {
                            ...
                            if (1 >= h && h > -1 && (c = 90 * d + 90 * h, t.rtl && (c = 90 * -d - 90 * h)), e.transform(l), t.params.cube.slideShadows) {
                                ...
                                0 === m.length && (m = a('<div class="swiper-slide-shadow-' + (t.isHorizontal() ? "left": "top") + '"></div>'), e.append(m)),
                                0 === n.length && (n = a('<div class="swiper-slide-shadow-' + (t.isHorizontal() ? "right": "bottom") + '"></div>'), e.append(n)),
                        ...
                        if (t.wrapper.css({
                        ...
                        }), t.params.cube.shadow) if (t.isHorizontal()) b.transform("translate3d(0px, " + (t.width / 2 + t.params.cube.shadowOffset) + "px, " + -t.width / 2 + "px) rotateX(90deg) rotateZ(0deg) scale(" + t.params.cube.shadowScale + ")");
                        else {
                            ...
                            b.transform("scale3d(" + q + ", 1, " + r + ") translate3d(0px, " + (t.height / 2 + s) + "px, " + -t.height / 2 / r + "px) rotateX(-90deg)")
                        }
                        var u = t.isSafari || t.isUiWebView ? -t.size / 2 : 0;
                        t.wrapper.tra nsform("translate3d(0px,0," + u + "px) rotateX(" + (t.isHorizontal() ? 0 : c) + "deg) rotateY(" + (t.isHorizontal() ? -c: 0) + "deg)")
                    },
                    setTransition: function(a) {
                ...
                coverflow: {
                    setTranslate: function() {
                        for (var b = t.translate,
                        c = t.isHorizontal() ? -b + t.width / 2 : -b + t.height / 2, d = t.isHorizontal() ? t.params.coverflow.rotate: -t.params.coverflow.rotate, e = t.params.coverflow.depth, f = 0, g = t.slides.length; g > f; f++) {
                            var h = t.slides.eq(f),
                            ...
                            if (h.transform(q), h[0].style.zIndex = -Math.abs(Math.round(k)) + 1, t.params.coverflow.slideShadows) {
                                ...
                                0 === r.length && (r = a('<div class="swiper-slide-shadow-' + (t.isHorizontal() ? "left": "top") + '"></div>'), h.append(r)),
                                0 === s.length && (s = a('<div class="swiper-slide-shadow-' + (t.isHorizontal() ? "right": "bottom") + '"></div>'), h.append(s)),
            ...
            t.lazy = {
                ...
                loadImageInSlide: function(b, c) {
                    if ("undefined" != typeof b && ("undefined" == typeof c && (c = !0), 0 !== t.slides.length)) {
                        var d = t.slides.eq(b),
                        ...
                        0 !== e.length && e.each(function() {
                            ...
                            t.loadImage(b[0], f || e, g, !1,
                            function() {
                                if (e ? (b.css("background-image", 'url("' + e + '")'), b.removeAttr("data-background")) : (g && (b.attr("srcset", g), b.removeAttr("data-srcset")), f && (b.attr("src", f), b.removeAttr("data-src"))), b.addClass("swiper-lazy-loaded").removeClass("swiper-lazy-loading"), d.find(".swiper-lazy-preloader, .preloader").remove(), t.params.loop && c) {
                                    var a = d.attr("data-swiper-slide-index");
                                    if (d.hasClass(t.params.slideDuplicateClass)) {
                                        var h = t.wrapper.children('[data-swiper-slide-index="' + a + '"]:not(.' + t.params.slideDuplicateClass + ")");
                                        t.lazy.loadImageInSlide(h.index(), !1)
                                    } else {
                                        var i = t.wrapper.children("." + t.params.slideDuplicateClass + '[data-swiper-slide-index="' + a + '"]');
                                        t.lazy.loadImageInSlide(i.index(), !1)
                                    }
                                }
                                t.emit("onLazyImageReady", t, d[0], b[0])
                            }),
                            t.emit("onLazyImageLoad", t, d[0], b[0])
                        })
                    }
                },
                load: function() {
                    ...
                    else if (t.params.slidesPerView > 1) for (b = t.activeIndex; b < t.activeIndex + t.params.slidesPerView; b++) t.slides[b] && t.lazy.loadImageInSlide(b);
                    ...
                    if (t.params.lazyLoadingInPrevNext) if (t.params.slidesPerView > 1 || t.params.lazyLoadingInPrevNextAmount && t.params.lazyLoadingInPrevNextAmount > 1) {
                        ...
                        for (b = t.activeIndex + t.params.slidesPerView; e > b; b++) t.slides[b] && t.lazy.loadImageInSlide(b);
                        for (b = f; b < t.activeIndex; b++) t.slides[b] && t.lazy.loadImageInSlide(b)
                    } else {
                        var g = t.wr apper.children("." + t.params.slideNextClass);
            ...
            t.scrollbar = {
                ...
                enableDraggable: function() {
                    var b = t.scrollbar,
                    c = t.support.touch ? b.track: document;
                    a(b.track).on(t.touchEvents.start, b.dragStart),
                    a(c).on(t.touchEvents.move, b.dragMove),
                    a(c).on(t.touchEvents.end, b.dragEnd)
                },
                disableDraggable: function() {
                    var b = t.scrollbar,
                    c = t.support.touch ? b.track: document;
                    a(b.track).off(t.touchEvents.start, b.dragStart),
                    a(c).off(t.touchEvents.move, b.dragMove),
                    a(c).off(t.touchEvents.end, b.dragEnd)
                },
                set: function() {
                    if (t.params.scrollbar) {
                        var b = t.scrollbar;
                        b.track = a(t.params.scrollbar),
                        t.params.uniqueNavElements && "string" == typeof t.params.scrollbar && b.track.length > 1 && 1 === t.container.find(t.params.scrollbar).length && (b.track = t.container.find(t.params.scrollbar)),
                        ...
                        b.trackSize = t.isHorizontal() ? b.track[0].offsetWidth: b.track[0].offsetHeight,
                        b.divider = t.size / t.virtualSize,
                        b.moveDivider = b.divider * (b.trackSize / t.size),
                        b.dragSize = b.trackSize * b.divider,
                        t.isHorizontal() ? b.drag[0].style.width = b.dragSize + "px": b.drag[0].style.height = b.dragSize + "px",
                        b.divider >= 1 ? b.track[0].style.display = "none": b.track[0].style.display = "",
                        t.params.scrollbarHide && (b.track[0].style.opacity = 0)
                    }
                },
                setTranslate: function() {
                    if (t.params.scrollbar) {
            ...
            t.controller = {
                LinearSpline: function(a, b) {
                    ...
                    this.interpolate = function(a) {
                        return a ? (d = e(this.x, a), c = d - 1, (a - this.x[c]) * (thi s.y[d] - this.y[c]) / (this.x[d] - this.x[c]) + this.y[c]) : 0
                    };
                    var e = function() {
                        var a, b, c;
                        return function(d, e) {
            ...
            t.disableKeyboardControl = function() {
                ...
                a(document).off("keydown", j)
            },
            t.enableKeyboardControl = function() {
                t.params.keyboardControl = !0,
                a(document).on("keydown", j)
            },
            t.mousewheel = {
                event: !1,
            ...
            t.disableMousewheelControl = function() {
                return t.mousewheel.event ? (t.container.off(t.mousewheel.event, k), !0) : !1
            },
            t.enableMousewheelControl = function() {
                return t.mousewheel.event ? (t.container.on(t.mousewheel.event, k), !0) : !1
            },
            t.parallax = {
                setTranslate: function() {
            ...
            t.off = function(a, b) {
                var c;
                if (a = m(a), "undefined" == typeof b) return t.emitterEventListeners[a] = [],
                t;
            ...
            t.a11y = {
                ...
                onEnterKey: function(b) {
                    13 === b.keyCode && (a(b.target).is(t.params.nextButton) ? (t.onClickNext(b), t.isEnd ? t.a11y.notify(t.params.lastSlideMessage) : t.a11y.notify(t.params.nextSlideMessage)) : a(b.target).is(t.params.prevButton) && (t.onClickPrev(b), t.isBeginning ? t.a11y.notify(t.params.firstSlideMessage) : t.a11y.notify(t.params.prevSlideMessage)), a(b.target).is("." + t.params.bulletClass) && a(b.target)[0].click())
                },
                ...
                initPagination: function() {
                    t.params.pagination && t.params.paginationClickable && t.bullets && t.bullets.length && t.bullets.each(function() {
                        var b = a(this);
                        t.a11y.makeFocusable(b),
                        t.a11y.addRole(b, "button"),
                        t.a11y.addLabel(b, t.params.paginationBulletMessage.replace(/{{index}}/, b.index() + 1))
                    })
                },
                destroy: function() {
    ...
    e = ["jQuery", "Zepto", "Dom7"], f = 0; f < e.length; f++) window[e[f]] && d(window[e[f]]);
    var g;
    g = "undefined" == typeof Dom7 ? window.Dom7 || window.Zepto || window.jQuery: Dom7,
    ...
    a.Swiper = c,
    a.Swiper.prototype.defaults = b
} ($),
+
function(a) {
    "use strict";
    a.Swiper.prototype.defaults.pagination = ".swiper-pagination",
    a.swipe r = function(b, c) {
    ...
    a.initSwiper = function(b) {
        var c = a(b || document.body),
        d = c.find(".swiper-container");
        if (0 !== d.length) for (var e = 0; e < d.length; e++) {
            var f, g = d.eq(e);
            g.data("swiper") ? g.data("swiper").update(!0) : (f = g.dataset(), a.swiper(g[0], f))
        }
    },
...
function(a) {
    ...
    var b = function(b) {
        ...
        d.close = function() {
            d.opened = !1,
            d.swiperContainer && 0 !== d.swiperContainer.length && (d.params.onClose && d.params.onClose(d), d.attachEvents(!0), "standalone" === d.params.type && d.container.removeClass("photo-browser-in").addClass("photo-browser-out").an imationEnd(function() {
                d.container.remove()
        ...
        d.onSlideGestureChange = function(a) {
            u && 0 !== u.length && (w = (a.scale || a.originalEvent.scale) * x, w > d.params.maxZoom && (w = d.params.maxZoom - 1 + Math.pow(w - d.params.maxZoom + 1, .5)), w < d.params.minZoom && (w = d.params.minZoom + 1 - Math.pow(d.params.minZoom - w + 1, .5)), u.transform("translate3d(0,0,0) scale(" + w + ")"))
        },
        ...
        d.onSlideTouchStart = function(b) {
            u && 0 !== u.length && (z || ("android" === a.device.os && b.preventDefault(), z = !0, Q = a.getTouchPosition(b)))
        },
        d.onSlideTouchMove = function(b) {
            if (u && 0 !== u.length && (d.swiper.allowClick = !1, z && t)) {
                ...
                if (! (c < d.swiper.width && e < d.swiper.height)) {
                    if (D = Math.min(d.swiper.width / 2 - c / 2, 0), F = -D, E = Math.min(d.swiper.height / 2 - e / 2, 0), G = -E, R = a.getTouchPosition(b), !A && !y && (Math.floor(D) === Math.floor(J) && R.x < Q.x || Math.floor(F) === Math.floor(J) && R.x > Q.x)) return void(z = !1);
                    b.preventDefault(),
                    b.stopPropagation(),
                    A = !0,
                    B = R.x - Q.x + J,
        ...
        d.swipeCloseTouchEnd = function() {
            ...
            }) : Y = !0, d.swiper.container.css("opacity", "").tran sition(""), void V.transform(""))
        },
        d
    };
    b.prototype = {
